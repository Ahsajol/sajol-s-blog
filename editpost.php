...
<?php if (!isset($_GET['editpostid']) || ($_GET['editpostid'] == NULL)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="select" name="cat">
                                    ...
                                    ?>
                                            <option <?php
                                                    if ($postresult['cat'] == $result['id']) { ?> selected="selected" <?php } ?> value="<?php echo $postresult['id']; ?>"><?php echo $result['name']; ?></option>
                                    <?php }
                                    } ?>
                                </select>
                            </td>
